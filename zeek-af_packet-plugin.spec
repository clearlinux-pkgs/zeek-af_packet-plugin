...
Version  : 4.0.0
Release  : 7
URL      : https://github.com/J-Gras/zeek-af_packet-plugin/archive/4.0.0/zeek-af_packet-plugin-4.0.0.tar.gz
Source0  : https://github.com/J-Gras/zeek-af_packet-plugin/archive/4.0.0/zeek-af_packet-plugin-4.0.0.tar.gz
...
%prep
%setup -q -n zeek-af_packet-plugin-4.0.0
cd %{_builddir}/zeek-af_packet-plugin-4.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672205280
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/zeek-af_packet-plugin-%{version}/COPYING %{buildroot}/usr/share/package-licenses/zeek-af_packet-plugin/47d40be49e9bbbef0991504c098ffac8fbdefc24
pushd clr-build
%make_install
popd

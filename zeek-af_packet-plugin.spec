...
Version  : 3.0.2
Release  : 2
URL      : https://github.com/J-Gras/zeek-af_packet-plugin/archive/3.0.2/zeek-af_packet-plugin-3.0.2.tar.gz
Source0  : https://github.com/J-Gras/zeek-af_packet-plugin/archive/3.0.2/zeek-af_packet-plugin-3.0.2.tar.gz
...
%prep
%setup -q -n zeek-af_packet-plugin-3.0.2
cd %{_builddir}/zeek-af_packet-plugin-3.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642789741
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/zeek-af_packet-plugin-3.0.2/COPYING %{buildroot}/usr/share/package-licenses/zeek-af_packet-plugin/47d40be49e9bbbef0991504c098ffac8fbdefc24
pushd clr-build
%make_install
popd
